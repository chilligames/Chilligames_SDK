 ...
 class JsonArray : List<object>
    {
        ...
        {
            return ChilligamesJson.SerializeObject(this) ?? string.Empty;
        }
    }
 ...
 IDictionary<string, object>
    {
        ...
        public override string ToString()
        {
            return ChilligamesJson.SerializeObject(_members);
        }
 ...
 class PocoJsonSerializerStrategy : IJsonSerializerStrategy
    {
        ...
        public virtual object DeserializeObject(object value, Type type)
        {
            ...
            if (nullableType != null && ChilligamesJson.NumberTypes.IndexOf(nullableType) != -1)
                type = nullableType; // Just use the regular type for the conversion
            bool isNumberType = ChilligamesJson.NumberTypes.IndexOf(type) != -1;
